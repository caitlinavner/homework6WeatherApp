...
$("#submitButton").on("click", function(event) {
  ...
  function addLI() {
    ...
    //liNode.setAttribute("type", "button");
    //liNode.setAttribute("onClick", oldSearch);
  ...
  console.log("something", city);
  var APIKey = "f34be33028ea32ef68b996c8f64d417e";
  var queryURLWeather =
    "https://api.openweathermap.org/data/2.5/weather?q=" +
    city +
    "&units=imperial&appid=" +
    APIKey;
  //main call for weather
  $.ajax({
    url: queryURLWeather,
    method: "GET"
  }).then(function(response) {
    //we're calling the city class from the html and putting the results in the h1 tag and adding whatever response is pulled and it will be the weather details
